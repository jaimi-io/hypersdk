...
// Source: github.com/jaimi-io/hypersdk/chain (interfaces: Action)
...
func (m *MockAction) Fee() (int64, ids.ID) {
	m.ctrl.T.Helper()
...
func (mr *MockActionMockRecorder) Fee() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Fee", reflect.TypeOf((*MockAction)(nil).Fee))
}
